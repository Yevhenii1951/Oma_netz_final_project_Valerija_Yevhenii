		...
		<div className='relative'>
			...
			<div className='space-y-6'>
				...
				<div className='space-y-6'>
					{activeTab === 'stats' && (
						<div className='space-y-6'>
							<section className='rounded-2xl border border-[#eadbcc] bg-gradient-to-r from-[#fffaf4] to-white p-4 sm:p-5 shadow-sm'>
								<SectionHeading
									icon={AlertTriangle}
										...
										{kpiCards.map(kpi => {
											...
											return (
												<div
													key={kpi.label}
													className={cn(
														'rounded-2xl border border-[#e8d5be] p-4 bg-gradient-to-br shadow-sm hover:shadow-md transition-shadow',
														kpi.tone,
													)}
												>
							...
							<section className='rounded-2xl border border-[#eadbcc] bg-gradient-to-br from-white to-[#fcf7f0] p-4 sm:p-5 shadow-sm'>
								<SectionHeading
